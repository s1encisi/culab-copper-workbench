...
| `codex/g6j` | G6i · 8a846b4 | `9cea2f9` | TabNet、FTTransformer、NODE 与匹配 MLP 对照；末个种子比较仍在运行，对照与验收待完成 |
| `codex/g6k` | G6j · ce9bd72 | `96bd78f` | GRU、LSTM、因果 TCN；独立研究验收通过 |
| `codex/g6l` | G6k · eb971c0；经 db7e771 合入 96bd78f | `65c2f5e` | TabPFN；五种子正式比较完成，保存工件回放验收仍在运行 |
