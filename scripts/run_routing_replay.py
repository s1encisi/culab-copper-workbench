...
if __name__=="__main__":
    ...
    print(json.dumps({"id":digest(["copper-research","owner",args.request_key])[:32],"status":"starting"}),flush=True)
    result=service.submit(Principal("owner","owner"),RoutingRequest(comparison_id=args.comparison_id,request_key=args.request_key))
