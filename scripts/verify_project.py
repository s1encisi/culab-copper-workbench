...
REQUIRED_PATHS = (
    ...
    "src/copper_mvp/neural_runtime.py",
    "src/copper_mvp/bayesian_problems.py",
    "src/copper_mvp/bayesian_optimizers.py",
    "src/copper_mvp/bayesian_audit.py",
    "src/copper_mvp/specialized_registry.py",
    "src/copper_mvp/specialized_models.py",
    "src/copper_mvp/specialized_evaluation.py",
    "requirements-specialized-models.txt",
    "scripts/setup_specialized_models.ps1",
    "requirements-neural-bo.txt",
    "scripts/setup_neural_bo.ps1",
