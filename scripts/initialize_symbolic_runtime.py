...
if __name__ == "__main__":
    ...
    record={"status":"initialized","pysr":pysr.__version__,"julia":julia_version,
            "symbolic_regression":symbolic_version,"manifest_sha256":file_hash(manifest),
            "project_sha256":file_hash(project),"research_data_sent":False}
