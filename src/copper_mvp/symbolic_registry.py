...
SYMBOLIC_SOURCE_FILES = tuple(
    "src/copper_mvp/" + name
    for name in (
        "symbolic_registry.py",
        "symbolic_runtime.py",
        "symbolic_models.py",
        "symbolic_sampling.py",
...
def symbolic_spec(seed):
    record = {
        "schema_version": "symbolic-registry.g6i.v1",
        "method_id": "SymbolicRegression",
        "method_version": SYMBOLIC_VERSION,
        "implementation": "PySR SymbolicRegression.jl evolutionary expression search",
        ...
        "multi_output": "two_independent_expression_searches",
        "seed": seed,
        ...
        "dimensional_policy": (
            "All searched variables and responses are dimensionless; physical u"
            "nits restored by stored affine transforms."
        ),
