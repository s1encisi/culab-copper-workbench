...
def tabpfn_spec(seed):
    record={"schema_version":"tabpfn-registry.g6l.v1","method_id":"TabPFN","method_version":TABPFN_VERSION,
        "implementation":"Prior Labs TabPFN v2 pretrained regression context model","package_version":"2.1.3",
        "requires_fit":True,"status":"registered","feature_count":114,"multi_output":"two_independent_context_models",
        "seed":seed,"target_transform":"delta_from_current","target_scaling":"train-only standard delta",
        "preprocessing":"train-only imputation, stable scaling, fixed one-hot categories and PCA8",
        "preset_parameters":dict(TABPFN_PARAMETERS),"sample_weight":"unsupported",
        "capabilities":{"sample_weight":False,"uncertainty":"raw_quantiles"},
        "uncertainty":"pretrained conditional marginal quantiles","dependencies":{},
        "isolated_dependencies":{"tabpfn":"2.1.3","scikit-learn":"1.6.1","torch":"2.8.0"},
        "weight_sha256":WEIGHT_SHA256,"weight_revision":"4972a65a1b30806315c6f92499959ffbfc69a673",
        "attribution":"Built with PriorLabs-TabPFN","license":"Prior Labs License 1.1",
        "pretraining_scope":"External pretrained prior; training data provenance is limited to the published model card.",
        "targets":[{"name":"cu","unit":"g/L"},{"name":"as","unit":"mg/L"}],
        "device":"cpu","network_access":"disabled in inference worker","automatic_promotion":False,
        "causal_control":False,"forecast_use":"research_comparison","optimization_proxy_approval":"requires_independent_qualification"}
