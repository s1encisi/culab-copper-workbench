...
) + ("requirements-tabular-neural.txt", "scripts/run_neural_controls.py", "scripts/run_tabular_benchmark.py")
...
def tabular_spec(method, seed):
    record = {
        "schema_version": "tabular-registry.g6j.v1",
        "method_id": method,
        "method_version": TABULAR_VERSION,
        "implementation": {
            "TabNet": "native pytorch-tabnet attentive network",
            "FTTransformer": "author rtdl FTTransformer",
            "NODE": "dense differentiable oblivious tree ensemble with sparsemax",
        }[method],
        "package_version": {"TabNet": "4.1.0", "FTTransformer": "0.0.2", "NODE": "g6j.node.v1"}[method],
        "dependencies": {"torch": "2.8.0", **TABULAR_PACKAGES},
        "requires_fit": True,
        "status": "registered",
        "feature_count": 114,
        ...
        "sample_weight": "weighted_two_target_MSE",
        "capabilities": {"sample_weight": True, "uncertainty": "unsupported"},
